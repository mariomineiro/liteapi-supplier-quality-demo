    ...
    <div>
      {searchKeys.length > 0 && (
        <div style={{ marginBottom: 12, display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
          <label htmlFor="ft-search" className="sr-only">Filter rows by name</label>
          <input
            id="ft-search"
            value={query}
            ...
            style={{
              flex: 1, minWidth: 200, background: "var(--bg-elev)", border: "1px solid var(--line)",
              color: "var(--ink)", padding: "9px 12px", borderRadius: 6, fontSize: 13,
            }}
          />
